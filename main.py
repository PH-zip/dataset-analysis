...
def main():
    ...
    red = conversor(R'C:\Users\jefee\OneDrive\Área de Trabalho\FACULDADE UFRPE\PROJETO 3\dataset-analysis-main\INFORMAÇÕES DE DADOS DOS VINHOS\winequality-red.csv', R'C:\Users\jefee\OneDrive\Área de Trabalho\FACULDADE UFRPE\PROJETO 3\dataset-analysis-main\INFORMAÇÕES DE DADOS DOS VINHOS\red.parquet')
    white = conversor(R'C:\Users\jefee\OneDrive\Área de Trabalho\FACULDADE UFRPE\PROJETO 3\dataset-analysis-main\INFORMAÇÕES DE DADOS DOS VINHOS\df_white.csv', R'C:\Users\jefee\OneDrive\Área de Trabalho\FACULDADE UFRPE\PROJETO 3\dataset-analysis-main\INFORMAÇÕES DE DADOS DOS VINHOS\white.parquet')
